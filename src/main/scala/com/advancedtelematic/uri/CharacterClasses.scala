...
private[uri] object CharacterClasses {
  ...
  val `cookie-octet-rfc-6265` = CharPredicate('\u0021',
                                              ...
                                              '\u003c' to '\u005b',
                                              '\u005d' to '\u007e')
  val `cookie-separator` = CharPredicate(parboiled2.EOI, ';')
  ...
  val `ctext-base` =
    CharPredicate(HTAB, SP, '\u0021' to '\u0027', '\u002A' to '\u005B', '\u005D' to '\u007E')
  ...
  val colonSlashEOI   = CharPredicate(':', '/', parboiled2.EOI)
